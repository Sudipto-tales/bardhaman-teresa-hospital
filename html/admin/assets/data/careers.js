...
(function (w) {
    ...
    w.TMH_SEED.applications = [
        ...
        { id: 'app-002', jobId: 'staff-nurse-icu', name: 'Rina Das', email: 'rina.das@example.com', phone: '+91 98311 44556', experience: '2 years — district hospital', currentEmployer: 'Burdwan Medical College', cvUrl: '#', coverNote: '', stage: 'new', rating: 0, appliedAt: '2026-08-01T08:44:00Z', order: 2, status: 'published' },
        { id: 'app-003', jobId: 'staff-nurse-icu', name: 'Sabina Yasmin', email: 'sabina.y@example.com', phone: '+91 90070 22334', experience: '6 years — cardiac ICU', currentEmployer: 'NH Rabindranath Tagore', cvUrl: '#', coverNote: 'Cardiac surgical ICU background, ACLS current.', stage: 'interview', rating: 5, appliedAt: '2026-07-29T16:20:00Z', order: 3, status: 'published' },
        { id: 'app-004', jobId: 'consultant-anaesthetist', name: 'Dr. Ashok Nandi', email: 'ashok.nandi@example.com', phone: '+91 98301 77889', experience: '9 years', currentEmployer: 'Private practice, Durgapur', cvUrl: '#', coverNote: '', stage: 'new', rating: 0, appliedAt: '2026-07-22T12:05:00Z', order: 4, status: 'published' },
        { id: 'app-005', jobId: 'radiographer', name: 'Tanmoy Saha', email: 'tanmoy.saha@example.com', phone: '+91 89100 33445', experience: '1 year', currentEmployer: 'Diagnostic centre, Bardhaman', cvUrl: '#', coverNote: '', stage: 'new', rating: 0, appliedAt: '2026-08-02T09:30:00Z', order: 5, status: 'published' },
        { id: 'app-006', jobId: 'radiographer', name: 'Moumita Pal', email: 'moumita.pal@example.com', phone: '+91 87770 55667', experience: '3 years', currentEmployer: 'Peerless Hospital', cvUrl: '#', coverNote: 'Comfortable with 16 and 64 slice CT.', stage: 'shortlisted', rating: 4, appliedAt: '2026-08-02T14:10:00Z', order: 6, status: 'published' },
        { id: 'app-007', jobId: 'front-desk-executive', name: 'Arnab Roy', email: 'arnab.roy@example.com', phone: '+91 90510 99001', experience: 'Fresher', currentEmployer: '', cvUrl: '#', coverNote: '', stage: 'rejected', rating: 2, appliedAt: '2026-07-02T11:00:00Z', order: 7, status: 'published' },
    ];
}(window));
