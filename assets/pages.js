    ...
    const initJob = () => {
        ...
        if (!job) {
            box.innerHTML = `<div class="cr-notfound">
                ...
                <a href="mailto:headhrtmh@gmail.com" class="arrow-link"><i
                        class="fa-solid fa-envelope"></i> Email headhrtmh@gmail.com</a>
            </div>`;
        ...
        if (mailto) {
            mailto.href = `mailto:headhrtmh@gmail.com?subject=${encodeURIComponent(`Application — ${job.title}`)}`;
        }
